...
exports[`namespace inputs dot-prisma.ts 1`] = `
...
type SendCommentThanksNotificationArgs = {
  ...
  comment: Prisma.Comment
  commentAuthor: Prisma.User
  commentThanksAuthor: Prisma.User
}

type SendPostCommentNotificationArgs = {
  post: Prisma.Post
  postAuthor: Prisma.User
  postComment: Prisma.PostComment
  postCommentAuthor: Prisma.User
}
...
const getBadgeName = (badgeType: Prisma.BadgeType): string => {
  switch (badgeType) {
    case Prisma.BadgeType.ALPHA_USER:
      return 'Alpha User'
    case Prisma.BadgeType.BETA_USER:
      return 'Beta User'
    case Prisma.BadgeType.TEN_POSTS:
      return '10 Posts'
    case Prisma.BadgeType.ONEHUNDRED_POSTS:
      return '100 Posts'
    case Prisma.BadgeType.CODE_CONTRIBUTOR:
